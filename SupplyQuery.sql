...
GO
INSERT [dbo].[Supply] ([SupplierID], [ItemID], [Date], [Volume]) VALUES (1, 1, CAST(N'2020-09-10' AS Date), 100)
GO
INSERT [dbo].[Supply] ([SupplierID], [ItemID], [Date], [Volume]) VALUES (1, 2, CAST(N'2020-10-12' AS Date), 200)
GO
INSERT [dbo].[Supply] ([SupplierID], [ItemID], [Date], [Volume]) VALUES (1, 3, CAST(N'2020-11-14' AS Date), 300)
GO
INSERT [dbo].[Supply] ([SupplierID], [ItemID], [Date], [Volume]) VALUES (1, 4, CAST(N'2020-09-11' AS Date), 500)
GO
INSERT [dbo].[Supply] ([SupplierID], [ItemID], [Date], [Volume]) VALUES (2, 1, CAST(N'2020-09-20' AS Date), 150)
GO
INSERT [dbo].[Supply] ([SupplierID], [ItemID], [Date], [Volume]) VALUES (2, 2, CAST(N'2020-09-21' AS Date), 250)
GO
INSERT [dbo].[Supply] ([SupplierID], [ItemID], [Date], [Volume]) VALUES (2, 3, CAST(N'2020-01-01' AS Date), 100)
GO
INSERT [dbo].[Supply] ([SupplierID], [ItemID], [Date], [Volume]) VALUES (3, 1, CAST(N'2020-12-30' AS Date), 1000)
GO
ALTER TABLE [dbo].[Supply]  WITH CHECK ADD  CONSTRAINT [FK_Поставка_Поставщик] FOREIGN KEY([SupplierID])
REFERENCES [dbo].[Supplier] ([ID])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[Supply] CHECK CONSTRAINT [FK_Поставка_Поставщик]
GO
ALTER TABLE [dbo].[Supply]  WITH CHECK ADD  CONSTRAINT [FK_Поставка_Товар] FOREIGN KEY([ItemID])
REFERENCES [dbo].[Item] ([ID])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[Supply] CHECK CONSTRAINT [FK_Поставка_Товар]
GO
